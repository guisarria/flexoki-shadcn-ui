...
export const Footer = () => {
  return (
    <footer className="mt-auto flex items-center justify-between bg-orange-primary px-4">
      <div className="flex items-center gap-x-4">
        <Link href="https://stephango.com/flexoki" target="_blank">
          <svg
          ...
          >
            <g clipPath="url(#a)">
              <path
                ...
                d="M40 19.99A19.99 19.99 0 0 0 20 0a19.99 19.99 0 1 0 20 19.98Z"
              ></path>
              <path
        ...
        <Link href="https://ui.shadcn.com/" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 256"
            className="mt-2 h-6 w-6 text-background"
          >
      ...
      <Link
        ...
        target="_blank"
        className="text-sm text-background sm:text-base"
      >
        made by guilherme sarria
      </Link>
    </footer>
  )
}
